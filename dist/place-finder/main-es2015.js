...
/* harmony import */ var _modules_shared_components_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/shared/components/page-not-found/page-not-found.component */ "./src/modules/shared/components/page-not-found/page-not-found.component.ts");
/* harmony import */ var _main_main_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../main/main.component */ "./src/main/main.component.ts");
...
const routes = [
    { path: 'find-places', component: _main_main_component__WEBPACK_IMPORTED_MODULE_3__["MainComponent"] },
    { path: '', pathMatch: 'full', redirectTo: 'find-places' },
    { path: '**', component: _modules_shared_components_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_2__["PageNotFoundComponent"] }
];
...
/* harmony import */ var _main_main_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../main/main.component */ "./src/main/main.component.ts");
/* harmony import */ var _modules_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../modules/shared/shared.module */ "./src/modules/shared/shared.module.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js");
/* harmony import */ var _core_interceptors_request_interceptor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../core/interceptors/request.interceptor */ "./src/core/interceptors/request.interceptor.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _core_interceptors_request_interceptor__WEBPACK_IMPORTED_MODULE_7__["RequestInterceptor"], multi: true },
    ], imports: [[
...
class PlacesService {
    ...
    getPlacesAutocomplete(location) {
        const httpParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('input', location);
        return this.http.get('/autocomplete', { params: httpParams }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(places => places['predictions']), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])((res) => this.locationsSubject.next(res)));
    }
    getPlacesSearch(query, type) {
        ...
        return this.http.get('/search', { params: httpParams }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(places => places['results']));
    }
    getPlaceDetails(placeId) {
        const httpParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('place_id', placeId).set('fields', 'name,rating,formatted_phone_number,photo,opening_hours');
        return this.http.get('/details', { params: httpParams }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(placeDetails => placeDetails['result']));
    }
}
PlacesService.ɵfac = function PlacesService_Factory(t) { return new (t || PlacesService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"])); };
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _core_services_places_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core/services/places.service */ "./src/core/services/places.service.ts");
/* harmony import */ var _modules_shared_components_header_header_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/shared/components/header/header.component */ "./src/modules/shared/components/header/header.component.ts");
/* harmony import */ var _modules_shared_components_search_form_search_form_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modules/shared/components/search-form/search-form.component */ "./src/modules/shared/components/search-form/search-form.component.ts");
/* harmony import */ var _modules_shared_components_card_card_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../modules/shared/components/card/card.component */ "./src/modules/shared/components/card/card.component.ts");
/* harmony import */ var _modules_shared_components_places_list_places_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../modules/shared/components/places-list/places-list.component */ "./src/modules/shared/components/places-list/places-list.component.ts");
/* harmony import */ var _modules_shared_components_map_map_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../modules/shared/components/map/map.component */ "./src/modules/shared/components/map/map.component.ts");
...
MainComponent.ɵfac = function MainComponent_Factory(t) { return new (t || MainComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_places_service__WEBPACK_IMPORTED_MODULE_1__["PlacesService"])); };
MainComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MainComponent, selectors: [["app-main"]], decls: 9, vars: 5, consts: [[3, "searchCriteriaChanged"], [1, "container"], [1, "container-list"], [3, "places", "title", "selectPlace"], [1, "container-map"], [3, "highlightedPlace", "zoom", "places"]], template: function MainComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-header");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "app-search-form", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("searchCriteriaChanged", function MainComponent_Template_app_search_form_searchCriteriaChanged_1_listener($event) { return ctx.searchCriteria($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectPlace", function MainComponent_Template_app_places_list_selectPlace_5_listener($event) { return ctx.selectPlace($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MainComponent, [{
    ...
    }], function () { return [{ type: _core_services_places_service__WEBPACK_IMPORTED_MODULE_1__["PlacesService"] }]; }, null); })();
...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 7, vars: 0, consts: [[1, "header"], [1, "header-user"], [1, "header-user-name"], ["src", "assets/images/MyPhoto.jpg", 1, "header-user-photo"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/* harmony import */ var _core_services_places_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../core/services/places.service */ "./src/core/services/places.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _place_details_place_details_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../place-details/place-details.component */ "./src/modules/shared/components/place-details/place-details.component.ts");
...
function MapComponent_agm_marker_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("markerClick", function MapComponent_agm_marker_2_Template_agm_marker_markerClick_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const place_r1 = ctx.$implicit; const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.getPlaceDetails(place_r1); });
...
MapComponent.ɵfac = function MapComponent_Factory(t) { return new (t || MapComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_places_service__WEBPACK_IMPORTED_MODULE_2__["PlacesService"])); };
MapComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MapComponent, selectors: [["app-map"]], viewQuery: function MapComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { highlightedPlace: "highlightedPlace", zoom: "zoom", places: "places" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_agm_core__WEBPACK_IMPORTED_MODULE_1__["LazyMapsAPILoader"]])], decls: 3, vars: 4, consts: [[2, "height", "500px", 3, "latitude", "longitude", "zoom"], [3, "animation", "latitude", "longitude", "markerDraggable", "markerClick", 4, "ngFor", "ngForOf"], [3, "animation", "latitude", "longitude", "markerDraggable", "markerClick"], [3, "placeDetails"]], template: function MapComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MapComponent, [{
    ...
    }], function () { return [{ type: _core_services_places_service__WEBPACK_IMPORTED_MODULE_2__["PlacesService"] }]; }, { agmMap: [{
...
PageNotFoundComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PageNotFoundComponent, selectors: [["app-page-not-found"]], decls: 1, vars: 0, consts: [["src", "assets/images/404.jpg", "alt", "404"]], template: function PageNotFoundComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _spinner_spinner_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../spinner/spinner.component */ "./src/modules/shared/components/spinner/spinner.component.ts");
...
function PlaceDetailsComponent_ng_container_1_h5_3_Template(rf, ctx) { if (rf & 1) {
...
function PlaceDetailsComponent_ng_container_1_h5_4_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h5");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function PlaceDetailsComponent_ng_container_1_h5_5_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h5");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function PlaceDetailsComponent_ng_container_1_ng_container_7_ng_container_2_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "div", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
} if (rf & 2) {
    const photo_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
function PlaceDetailsComponent_ng_container_1_ng_container_7_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
function PlaceDetailsComponent_ng_container_1_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
function PlaceDetailsComponent_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
function PlaceDetailsComponent_ng_template_2_Template(rf, ctx) { if (rf & 1) {
...
PlaceDetailsComponent.ɵfac = function PlaceDetailsComponent_Factory(t) { return new (t || PlaceDetailsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"])); };
PlaceDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PlaceDetailsComponent, selectors: [["app-place-details"]], inputs: { placeDetails: "placeDetails" }, decls: 4, vars: 2, consts: [[1, "details-container"], [4, "ngIf", "ngIfElse"], ["Loading", ""], [3, "color", 4, "ngIf"], [4, "ngIf"], [1, "photo"], [4, "ngFor", "ngForOf"], [1, "photo-container"], [1, "photo-item", 3, "src"], [1, "photo-attribution", 3, "innerHTML"], [1, "spinner-container"]], template: function PlaceDetailsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PlaceDetailsComponent, [{
    ...
    }], function () { return [{ type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"] }]; }, { placeDetails: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }] }); })();
...
function PlacesListComponent_ng_container_1_li_5_Template(rf, ctx) { if (rf & 1) {
    const _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mouseenter", function PlacesListComponent_ng_container_1_li_5_Template_li_mouseenter_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const place_r4 = ctx.$implicit; const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r5.onPlaceHover(place_r4); })("mouseleave", function PlacesListComponent_ng_container_1_li_5_Template_li_mouseleave_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r7.onPlaceNotHovered(); });
...
function PlacesListComponent_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
function PlacesListComponent_ng_template_2_Template(rf, ctx) { if (rf & 1) {
...
PlacesListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PlacesListComponent, selectors: [["app-places-list"]], inputs: { title: "title", places: "places" }, outputs: { selectPlace: "selectPlace" }, decls: 4, vars: 2, consts: [[1, "list"], [4, "ngIf", "ngIfElse"], ["NoResults", ""], [1, "list-title"], [1, "list-scrollbar"], [1, "list-scrollable"], ["class", "list-item", 3, "mouseenter", "mouseleave", 4, "ngFor", "ngForOf"], [1, "list-item", 3, "mouseenter", "mouseleave"], [1, "list-no-results"]], template: function PlacesListComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/* harmony import */ var _core_services_places_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../core/services/places.service */ "./src/core/services/places.service.ts");
...
function SearchFormComponent_mat_option_7_Template(rf, ctx) { if (rf & 1) {
...
function SearchFormComponent_mat_option_15_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
class SearchFormComponent {
    ...
    ngOnInit() {
        this.searchForm.get('location').valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(value => value.replace(' ', '+')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(500)).
            subscribe(value => {
...
SearchFormComponent.ɵfac = function SearchFormComponent_Factory(t) { return new (t || SearchFormComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_places_service__WEBPACK_IMPORTED_MODULE_4__["PlacesService"])); };
SearchFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SearchFormComponent, selectors: [["app-search-form"]], outputs: { searchCriteriaChanged: "searchCriteriaChanged" }, decls: 16, vars: 6, consts: [[3, "formGroup"], ["appearance", "outline"], ["type", "text", "placeholder", "Location", "matInput", "", "autofocus", "", "formControlName", "location", 3, "matAutocomplete"], [3, "optionSelected"], ["auto", "matAutocomplete"], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "type", 3, "selectionChange"], [3, "value"]], template: function SearchFormComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionSelected", function SearchFormComponent_Template_mat_autocomplete_optionSelected_5_listener() { return ctx.onSearchCriteriaChanged(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectionChange", function SearchFormComponent_Template_mat_select_selectionChange_12_listener() { return ctx.onSearchCriteriaChanged(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SearchFormComponent, [{
    ...
    }], function () { return [{ type: _core_services_places_service__WEBPACK_IMPORTED_MODULE_4__["PlacesService"] }]; }, { searchCriteriaChanged: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"]
        }] }); })();
...
/* harmony import */ var _components_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/page-not-found/page-not-found.component */ "./src/modules/shared/components/page-not-found/page-not-found.component.ts");
/* harmony import */ var _components_map_map_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/map/map.component */ "./src/modules/shared/components/map/map.component.ts");
...
/* harmony import */ var _components_search_form_search_form_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/search-form/search-form.component */ "./src/modules/shared/components/search-form/search-form.component.ts");
...
/* harmony import */ var _components_place_details_place_details_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/place-details/place-details.component */ "./src/modules/shared/components/place-details/place-details.component.ts");
/* harmony import */ var _components_card_card_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/card/card.component */ "./src/modules/shared/components/card/card.component.ts");
/* harmony import */ var _components_places_list_places_list_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/places-list/places-list.component */ "./src/modules/shared/components/places-list/places-list.component.ts");
/* harmony import */ var ngx_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ngx-perfect-scrollbar */ "./node_modules/ngx-perfect-scrollbar/__ivy_ngcc__/fesm2015/ngx-perfect-scrollbar.js");
/* harmony import */ var _components_spinner_spinner_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/spinner/spinner.component */ "./src/modules/shared/components/spinner/spinner.component.ts");
/* harmony import */ var _components_header_header_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/header/header.component */ "./src/modules/shared/components/header/header.component.ts");
...
module.exports = __webpack_require__(/*! C:\Users\farah\theplacefinder\src\main.ts */"./src/main.ts");
